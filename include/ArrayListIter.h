 ...
 */
     ...
     */
    ArrayListIterator<T> operator+(int32_t offset) const;
     ...
     */
    int32_t operator-(const ArrayListIterator<T>& rhs) const;
     ...
     */
    ArrayListIterator<T>& operator+=(int32_t offset);
...
private:
    ...
    template <typename X>
    friend ArrayListIterator<X> operator+(int32_t offset, const ArrayListIterator<X>& iter);
...
public:
     ...
     * @return The iterator before the increment.
     */
    ArrayListConstIterator<T> operator++(int32_t);
     ...
     * @return the moved iterator.
     */
    ArrayListConstIterator<T> operator+(int32_t offset) const;
     ...
     * @return *this after the operation
     */
    ArrayListConstIterator<T>& operator+=(const int32_t offset);
